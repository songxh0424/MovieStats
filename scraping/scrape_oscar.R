...
saveRDS(dirInfos1, file = '../RData/dirOscar1.rds')
...
dirInfos = c(readRDS('../RData/dirOscar1.rds'), dirInfos2)
...
saveRDS(actInfos1, file = '../RData/actOscar1.rds')
...
saveRDS(actInfos2, file = '../RData/actOscar2.rds')
